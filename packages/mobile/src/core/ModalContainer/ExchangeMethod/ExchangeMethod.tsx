...
export const ExchangeMethod: FC<ExchangeMethodProps> = ({
  methodId,
  onContinue,
}) => {
      ...
      <View style={styles.container}>
        ...
        <Modal.Content safeArea>
          <View style={{ marginBottom: 16 }}>
            ...
            <S.Buttons>
              <Button onPress={handleContinue} style={{backgroundColor: colors.Primary}}>
                {method.action_button.title}
              </Button>
...
export async function openExchangeMethodModal(
  methodId: string,
  onContinue?: () => void
) {
